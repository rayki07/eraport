        ...
        <form action="{{ route('guru.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nip" id="nip"
                        ...
                        placeholder="Contoh: 001" value="{{ old('nip') }}">
                ...
                <div>
                    ...
                    <input type="text" name="nama_lengkap" id="nama_lengkap" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Contoh: Firman Wahyudi" value="{{ old('nama_lengkap') }}">
                ...
                <div>
                    ...
                    <input type="text" name="nama_panggilan" id="nama_panggilan"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Contoh: Firman" value="{{ old('nama_panggilan') }}">
                ...
                <div>
                    ...
                    <select name="gender" id="gender" required
                        ...
                        <option value="L" 
                            @if(old('gender') == 'L') selected @endif>
                            Laki-laki
                        </option>
                        
                        <option value="P" 
                            @if(old('gender') == 'P') selected @endif>
                            Perempuan
                        </option>
