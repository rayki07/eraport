    ...
    <div class="bg-white rounded-xl shadow-lg p-4 md:p-6">
        ...
        <div class="flex items-center justify-between border-b pb-4 mb-4">
            <div class="flex items-center space-x-2 text-gray-700">
                ...
                <h2 class="text-xl font-semibold">{{ $kelas->rombel }} {{ $kelas->nama_kelas }} ( {{ $mulai }} / {{ $selesai }} )</h2>
            </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-3 whitespace-nowrap text-center text-sm font-medium">
                                    <a href="{{ route('kelas.siswa.show', [$kelas, $item]) }}" class="inline-flex items-center bg-green-500 text-white py-1.5 px-3 rounded-lg text-xs font-semibold hover:bg-green-600 transition-colors shadow-md">
